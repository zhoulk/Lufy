...
namespace LF.Setting
{
    ...
    [AddComponentMenu("Lufy/Setting")]
    public class SettingManager : LufyManager
    {
        ...
        public void SetSettingHelper(ISettingHelper settingHelper)
        {
            ...
            {
                throw new LufyException("Setting helper is invalid.");
            }
        ...
        public bool HasSetting(string settingName)
        {
            ...
            {
                throw new LufyException("Setting name is invalid.");
            }
