...
namespace LF.UI
{
    ...
    {
        public override int Id => OpenUIFormSuccessEventArgs.EventId;

        public static int EventId = typeof(OpenUIFormSuccessEventArgs).GetHashCode();
