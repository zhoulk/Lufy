    ...
    public static partial class Utility
    {
        ...
        public static class Converter
        {
            ...
            public static void GetBytes(bool value, byte[] buffer, int startIndex)
            {
                if (buffer == null)
                {
                    throw new LufyException("Buffer is invalid.");
                }

                if (startIndex < 0 || startIndex + 1 > buffer.Length)
                {
                    throw new LufyException("Start index is invalid.");
                }
            ...
            /// <param name="buffer">用于存放结果的字节数组。</param>
            /// <param name="startIndex">buffer 内的起始位置。</param>
            public static void GetBytes(short value, byte[] buffer, int startIndex)
            {
                if (buffer == null)
                {
                    throw new LufyException("Buffer is invalid.");
            ...
            /// <param name="buffer">用于存放结果的字节数组。</param>
            /// <param name="startIndex">buffer 内的起始位置。</param>
            public static void GetBytes(int value, byte[] buffer, int startIndex)
            {
                if (buffer == null)
                {
                    throw new LufyException("Buffer is invalid.");
            ...
            /// <param name="buffer">用于存放结果的字节数组。</param>
            /// <param name="startIndex">buffer 内的起始位置。</param>
            public static void GetBytes(long value, byte[] buffer, int startIndex)
            {
                if (buffer == null)
                {
                    throw new LufyException("Buffer is invalid.");
            ...
            /// <param name="buffer">用于存放结果的字节数组。</param>
            /// <param name="startIndex">buffer 内的起始位置。</param>
            public static void GetBytes(float value, byte[] buffer, int startIndex)
            {
                //GetBytes(value, buffer, startIndex);
            ...
            /// <param name="buffer">用于存放结果的字节数组。</param>
            /// <param name="startIndex">buffer 内的起始位置。</param>
            public static void GetBytes(double value, byte[] buffer, int startIndex)
            {
                //GetBytes(value, buffer, startIndex);
                if (buffer == null)
                {
            ...
            public static string GetString(byte[] value)
            {
                if (value == null)
                {
                    throw new LufyException("Value is invalid.");
                }
